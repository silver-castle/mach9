...
from mach9.router import RouteExists, RouteDoesNotExist
...
def test_shorthand_routes_get():
    app = Mach9('test_shorhand_routes_get')
...
def test_route_optional_slash():
    app = Mach9('test_route_optional_slash')
...
def test_shorthand_routes_post():
    app = Mach9('test_shorhand_routes_post')
...
def test_shorthand_routes_put():
    app = Mach9('test_shorhand_routes_put')
...
def test_shorthand_routes_delete():
    app = Mach9('test_shorhand_routes_delete')
...
def test_shorthand_routes_patch():
    app = Mach9('test_shorhand_routes_patch')
...
def test_shorthand_routes_head():
    app = Mach9('test_shorhand_routes_head')
...
def test_shorthand_routes_options():
    app = Mach9('test_shorhand_routes_options')
...
def test_dynamic_route_string():
    app = Mach9('test_dynamic_route_string')
...
def test_dynamic_route_int():
    app = Mach9('test_dynamic_route_int')
...
def test_dynamic_route_number():
    app = Mach9('test_dynamic_route_number')
...
def test_dynamic_route_regex():
    app = Mach9('test_dynamic_route_regex')
...
def test_dynamic_route_path():
    app = Mach9('test_dynamic_route_path')
...
def test_dynamic_route_unhashable():
    app = Mach9('test_dynamic_route_unhashable')
...
def test_route_duplicate():
    app = Mach9('test_route_duplicate')
...
def test_method_not_allowed():
    app = Mach9('test_method_not_allowed')
...
def test_static_add_route():
    app = Mach9('test_static_add_route')
...
def test_dynamic_add_route():
    app = Mach9('test_dynamic_add_route')
...
def test_dynamic_add_route_string():
    app = Mach9('test_dynamic_add_route_string')
...
def test_dynamic_add_route_int():
    app = Mach9('test_dynamic_add_route_int')
...
def test_dynamic_add_route_number():
    app = Mach9('test_dynamic_add_route_number')
...
def test_dynamic_add_route_unhashable():
    app = Mach9('test_dynamic_add_route_unhashable')
...
def test_add_route_duplicate():
    app = Mach9('test_add_route_duplicate')
...
def test_add_route_method_not_allowed():
    app = Mach9('test_add_route_method_not_allowed')
...
def test_remove_static_route():
    app = Mach9('test_remove_static_route')
...
def test_remove_dynamic_route():
    app = Mach9('test_remove_dynamic_route')
...
def test_remove_inexistent_route():
    app = Mach9('test_remove_inexistent_route')
...
def test_remove_unhashable_route():
    app = Mach9('test_remove_unhashable_route')
