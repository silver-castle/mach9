...
from mach9.response import text, HTTPResponse
from mach9.views import HTTPMethodView, CompositionView
...
def test_unexisting_methods():
    app = Mach9('test_unexisting_methods')
...
def test_argument_methods():
    app = Mach9('test_argument_methods')
...
def test_with_middleware():
    app = Mach9('test_with_middleware')
...
def test_with_middleware_response():
    app = Mach9('test_with_middleware_response')
    ...
    async def process_response1(request, response):
        results.append(request)
...
def test_with_custom_class_methods():
    app = Mach9('test_with_custom_class_methods')
    ...
    class DummyView(HTTPMethodView):
        ...
        def get(self, request):
            ...
            return text(
                'I am get method and global var is {}'.format(self.global_var))
