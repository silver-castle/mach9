...
class HTTPMethodView:
    """Simple class based implementation of view for the mach9.
...
class CompositionView:
    """Simple method-function mapped view for the mach9.
    ...
    def __init__(self, invalid_usage=None):
        self.handlers = {}
